    ...
    <div className="min-h-screen bg-[#f0ead6]" style={{ fontFamily: 'var(--font-right-grotesk)' }}>
      ...
      <main className="px-8 py-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          ...
          {/* Card LinkedIn */}
          <div className="bg-blue-500 text-white p-8 flex flex-col justify-between min-h-[300px]">
            <div>
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 text-white bg-[#0072b1] hover:bg-blue-700 transition-colors py-3 px-6 rounded"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
