    ...
    <div className="min-h-screen bg-white" style={{ fontFamily: 'var(--font-right-grotesk)' }}>
      ...
      <main className="px-8 py-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          ...
          {/* Card LinkedIn */}
          <div className="bg-blue-600 text-white p-8 flex flex-col justify-between min-h-[300px]">
            <div>
              <h3 className="text-2xl font-bold uppercase mb-4">LINKEDIN</h3>
              <p className="text-white leading-relaxed mb-6">
                Urmărește-ne pe LinkedIn pentru a vedea proiectele noastre și 
                pentru a rămâne la curent cu activitatea noastră.
              </p>
            ...
            <a 
              href="https://www.linkedin.com/in/corina-iliescu-10208711/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 text-white bg-blue-500 hover:bg-blue-700 transition-colors py-3 px-6 rounded"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
